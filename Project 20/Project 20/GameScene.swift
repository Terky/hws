...
//  Project 20
//
//  Created by Артём Бурмистров on 4/24/20.
...
class GameScene: SKScene {
    ...
    @objc func launchFireworks() {
        ...
        case 0:
            for i in 0...4 {
                createFirework(xMovement: 0, x: 312 + i * 100, y: bottomEdge)
            }
            
        case 1:
            for i in 0...4 {
                createFirework(xMovement: CGFloat(-200 + i * 100), x: 312 + i * 100, y: bottomEdge)
            }
