...
//  Project 8
//
//  Created by Артём Бурмистров on 3/21/20.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            cluesLabel.leadingAnchor.constraint(
                equalTo: view.layoutMarginsGuide.leadingAnchor, constant: 100),
            cluesLabel.widthAnchor.constraint(
                equalTo: view.layoutMarginsGuide.widthAnchor, multiplier: 0.6,
                constant: -100),
            ...
            answersLabel.widthAnchor.constraint(
                equalTo: view.layoutMarginsGuide.widthAnchor, multiplier: 0.4,
                constant: -100),
        ...
        for row in 0..<4 {
            for column in 0..<5 {
                ...
                let frame = CGRect(x: column * width, y: row * height,
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        guard let solutionPosition = solutions.firstIndex(of: answerText) else {
            let ac = UIAlertController(title: "Sorry, wrong answer :(", message: "Try again", preferredStyle: .alert)
        ...
        var splitAnsers = answersLabel.text?.components(separatedBy: "\n")
        splitAnsers?[solutionPosition] = answerText
        answersLabel.text = splitAnsers?.joined(separator: "\n")
    ...
    func loadLevel() {
        ...
        answersLabel.text = solutionsString.trimmingCharacters(
            in: .whitespacesAndNewlines)
